...
{if isset($orderby) AND isset($orderway)}
    ...
    <form id="productsSortForm" action="{$request|escape:'htmlall':'UTF-8'}">
            ...
            <select id="selectPrductSort" class="selectProductSort" >
                <option value="{$orderbydefault|escape:'htmlall':'UTF-8'}:{$orderwaydefault|escape:'htmlall':'UTF-8'}" {if $orderby eq $orderbydefault}selected="selected"{/if}>{l s='By Relevance'}</option>
                {if !$PS_CATALOG_MODE}
