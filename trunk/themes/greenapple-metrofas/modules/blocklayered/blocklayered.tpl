...
<div id="layered_block_left" class="block block-verticalmenu">
 ...
 <div class="block-title ma-new-vertscroller-title"><strong><span class="word1">{l s='Filter' mod='blocklayered'}</span> <span class="word2">{l s=' By' mod='blocklayered'}</span> </strong></div>
									...
									{if isset($filter.slider)}
										{if $smarty.foreach.f_values.first}
											<li>
                                                ...
                                                {$filter.unit|escape:html:'UTF-8'} {$filter.values[0]|escape:html:'UTF-8'}-
                                                {$filter.unit|escape:html:'UTF-8'} {$filter.values[1]|escape:html:'UTF-8'}
											</li>
										{/if}
									{else}
