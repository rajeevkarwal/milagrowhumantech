...
<div class="block block-list block-layered-nav  block-verticalmenu">

     <div class="block-title ma-new-vertscroller-title"><strong><span class="word1">{l s='Manufacturers' mod='blockmanufacturer'}</span> <span class="word2">{l s=' By' mod='blockmanufacturer'}</span> </strong></div>

    <div class="block-content left-categorys-container">
       {if $manufacturers}
	{if $text_list}
	<ul id="ma-accordion"  class="bullet accordion">
