                        ...
                        <form action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" class="std" id="form_forgotpassword">
                            <fieldset>
                                ...
                                {if isset($confirmation) && $confirmation == 1}
                                    <p class="success">{l s='Your password has been successfully reset and a confirmation has been sent to your email address:'} {if isset($cust_email)}{$cust_email|escape:'htmlall':'UTF-8'|stripslashes}{/if}</p>
                                {elseif isset($confirmation) && $confirmation == 2}
                                    <p class="success">{l s='A confirmation email has been sent to your address:'} {if isset($cust_email)}{$cust_email|escape:'htmlall':'UTF-8'|stripslashes}{/if}</p>
                                {else}
                                    ...
                                    <p class="submit">
                                        <button type="submit" class="button left" ><span><span>{l s='Retrieve Password'}</span></span></button>
                                    </p>
                                    <br>
                                    <p class="clear">
