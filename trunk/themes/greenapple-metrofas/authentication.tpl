...
{if !isset($email_create)}
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#create-account_form').submit(function () {
                submitFunction($('#back_create_account').val());
                return false;
            });
            $('#SubmitCreate').click(function () {
                submitFunction($('#back_login_account').val());
            });
        });
        function submitFunction(back) {
    ...
    <div class="page-title">
     ...
     <p class="cms-banner-img"><img src="/img/cms/cms-banners/login.png" alt="login-image"></p>
    <div class="col2-set">
    ...
    <div class="col2-set">
        <div class="col-1 new-users">
            <div class="buttons-set">
                {if isset($back)}<input type="hidden" class="hidden" id="back_create_account" name="back"
        ...
        <div class="col-2 registered-users">
            <div class="buttons-set">
                ...
                {if isset($back)}<input type="hidden" class="hidden" name="back" id="back_login_account"
                                        value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
