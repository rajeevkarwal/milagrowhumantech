        ...
        <div class="main">
            <div class="main-inner">
                <div class="col-main">
                    <div class="account-login input-type-field">
                        ...
                        <div class="page-title">
						   ...
						   <p class="cms-banner-img"><img alt="milagrow-trackorder-banner" src="/img/cms/cms-banners/my-vouchers.png"></p>

                        {if isset($cart_rules) && count($cart_rules) && $nb_cart_rules}

                            <table id="shopping-cart-table" class="discount data-table cart-table">
                                <col width="1" />
                                <col />
                                <col width="1" />
                                <col width="1" />
                                ...
                                <thead>
                                    <tr>
                                        <th class="discount_code first_item" rowspan="1">{l s='Code'}</th>
                                        <th class="discount_description item" rowspan="1">{l s='Description'}</th>
                                        <th class="discount_quantity item" rowspan="1">{l s='Quantity'}</th>
                                        <th class="discount_value item" rowspan="1">{l s='Value'}*</th>
                                        <th class="discount_minimum item" rowspan="1">{l s='Minimum'}</th>
                                        <th class="discount_cumulative item" rowspan="1">{l s='Cumulative'}</th>
                                        <th class="discount_expiration_date last_item" rowspan="1">{l s='Expiration date'}</th>
                                    </tr>
                                </thead>
                                <tbody>
                ...
                <ul class="footer_links">
                    ...
                    <li class="f_right"><a href="{$base_dir}"><img src="{$img_dir}icon/home.gif" class="icon"  alt="" /> {l s='Home'}</a></li>
                </ul>
            </div>
        </div>
    </div> 
