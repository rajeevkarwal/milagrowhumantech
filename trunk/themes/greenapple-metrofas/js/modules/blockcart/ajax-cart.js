...
var ajaxCart = {
    ...
    add: function (idProduct, idCombination, addedFromProductPage, callerElement, quantity, whishlist) {
        ...
        if (addedFromProductPage) {
            $('body#product p#add_to_cart button').attr('disabled', true).removeClass('exclusive').addClass('exclusive_disabled');
                ...
                if (cartBlockOffset != undefined && $picture.size()) {
                    ...
                    $picture.css({ 'position': 'absolute', 'top': $picture.css('top'), 'left': $picture.css('left'), 'z-index': 4242 })
                        ...
                        .fadeOut(100, function () {
                            ...
                            alert("The item has been added to the cart. You can continue shopping or go to the top of page for checkout.");
                        });
                }
                else
                    ajaxCart.updateCartInformation(jsonData, addedFromProductPage);
        ...
        $(jsonData.products).each(function () {
            ...
            if (this.id != undefined) {
                ...
                if ($('#cart_block dt#cart_block_product_' + domIdProduct).length == 0) {
                    ...
                    content += '<a href="' + this.link + '" title="' + this.name + '"><img src="' + this.id_image + '" width="50" height="50" alt="' + this.name + '"></a>';
    ...
    updateCartEverywhere: function (jsonData) {
        //updated given below line jsonData.productTotal to total
