...
{include file="$tpl_dir./breadcrumb.tpl"}
            ...
            <div class="main-inner">
                <div class="col-main">
                    <div class="cart">
                        ...
                        <p class="cms-banner-img"><img alt="milagrow-trackorder-banner" src="/img/cms/cms-banners/rma.png"></p>
        ...
        <div class="block-center" id="block-history">
            {if $ordersReturn && count($ordersReturn)}
                <table id="order-list" class="data-table cart-table">
                    <col width="1" />
                    <col />
                    <col width="1" />
                    <col width="1" />
                    ...
                    <thead>
                        <tr>
                            <th class="first_item" rowspan="1">{l s='Return'}</th>
                            <th class="item" rowspan="1">{l s='Order'}</th>
                            <th class="item" rowspan="1">{l s='Package status'}</th>
                            <th class="item" rowspan="1">{l s='Date issued'}</th>
                            <th class="last_item" rowspan="1">{l s='Return slip'}</th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        <ul class="footer_links">
            ...
            <li class="f_right"><a href="{$base_dir}"><img src="{$img_dir}home-icon.png" alt=""  /></a><a href="{$base_dir}">{l s='Home'}</a></li>
        </ul>
    </div>
</div>
</div>
