            ...
            <form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")}" method="post" id="login_form" class="std">
                <fieldset>
                    ...
                    <div id="login_form_content" style="display:none;">
                        ...
                        <button type="submit" id="SubmitLogin" name="SubmitLogin" class="button left"  ><span><span>{l s='Login'}</span></span></button>
                    </p>
                </div>
            </fieldset>
        </form>
            ...
            <fieldset>
                ...
                <div id="opc_account_choice">
                    <div class="opc_float">
                        ...
                        <p>
                            <button type="button" class="button" id="opc_guestCheckout"><span><span>{l s='Guest checkout'}</span></span></button>
                        </p>
                    </div>
                    ...
                    <div class="opc_float">
                        ...
                        <p>
                            <button type="button" class="button" id="opc_createAccount" ><span><span>{l s='Create an account'}</span></span></button>
                        </p>
                    </div>
                    <div class="clear"></div>
                </div>
                <div id="opc_account_form">
                    ...
                    <p class="submit">
                        <button type="submit" class="button" name="submitAccount" id="submitAccount" ><span><span>{l s='Save'}</span></span></button>
                    </p>
