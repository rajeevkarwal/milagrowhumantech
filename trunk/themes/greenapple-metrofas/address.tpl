...
<div class="main">
    <div class="main-inner">
        <div class="col-main">
			...
			<p class="cms-banner-img"><img alt="milagrow-trackorder-banner" src="/img/cms/cms-banners/my-addresses.png"></p>
                ...
                <form action="{$link->getPageLink('address', true)}" method="post" class="std " id="add_address">
                    <fieldset class="account_creation">
                        ...
                        {assign var="addresstitletoprint" value="false"}
                        {foreach from=$ordered_adr_fields item=field_name}
                            ...
                            {if $field_name eq 'address2'}
                                ...
                                {assign var="addresstitletoprint" value="true"}
                            {/if}

                            {if $addresstitletoprint eq 'true'}
                            <p class="required text clearfix" id="adress_alias">
                                <label for="alias">{l s='Please specify a title ( eg. Office, Residence) to the address filled above.'} <sup>*</sup></label>
