			...
			<li id="wlp_{$product.id_product}_{$product.id_product_attribute}" class="clearfix address {if $smarty.foreach.i.index % 2}alternate_{/if}item">
				...
				<div class="clearfix">
					...
					<div class="product_infos">
						...
						{/if}
							<br />{l s='Quantity' mod='blockwishlist'}:<input type="text" id="quantity_{$product.id_product}_{$product.id_product_attribute}" style="width:30px;" value="{$product.quantity|intval}" size="3"  />
							<br /><br />
