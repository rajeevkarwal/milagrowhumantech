                ...
                {else}
                    ...
                    <form action="{$link->getModuleLink('cheque', 'validation', [], true)}" method="post">
                        ...
                        <p class="cart_navigation">
                            <button type="submit" name="submit"  class="button"><span><spna>{l s='I confirm my order' mod='cheque'}</span></span></button>
                            <button onclick="window.location='{$link->getPageLink('order', true, NULL, "step=3")}'"  title="{l s='Other payment methods' mod='cheque'}" class="button right" type="button"><span><span>{l s='Other payment methods' mod='cheque'}</span></span></button>
                        </p>
                    </form>
                {/if}  
            </div>
