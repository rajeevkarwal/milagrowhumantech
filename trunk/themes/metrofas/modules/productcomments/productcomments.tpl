				...
				<div class="comment_details">
					...
					<ul>
						...
						{if $logged == 1}
							...
							<li>{l s='Was this comment useful to you?' mod='productcomments'}<button class="button comments_btn" data-is-usefull="1" data-id-product-comment="{$comment.id_product_comment}"><span><span>{l s='yes' mod='productcomments'}</span></span></button><button class="button" data-is-usefull="0" data-id-product-comment="{$comment.id_product_comment}"><span><span>{l s='no' mod='productcomments'}</span></span></button></li>
							{/if}
		...
		<form action="#">
			...
			<div class="new_comment_form_content">
				...
				<div id="new_comment_form_footer">
					...
					<p class="fr">
						<button id="submitNewMessage" name="submitMessage" class="button" type="submit"><span><span>{l s='Send' mod='productcomments'}</span></span></button>&nbsp;
