...
{if isset($p) AND $p}
    ...
    {if $start!=$stop}
        <strong>{l s='Page:'}</strong>
        <ol>
            {if $p != 1}
                {assign var='p_previous' value=$p-1}
                <li  ><a class="previous i-previous" {$no_follow_text} href="{$link->goPage($requestPage, $p_previous)}">
                        <img class="v-middle" alt="{l s='Previous'}" src="{$img_dir}pager_arrow_left.gif">
                    </a></li>
                {else}
                <li  ><a class="previous i-previous hidden" {$no_follow_text} href="#">
                        <img class="v-middle" alt="{l s='Previous'}" src="{$img_dir}pager_arrow_left.gif">
                    </a>
                </li>
            {/if}
            ...
            {if $pages_nb > 1 AND $p != $pages_nb}
                ...
                <li ><a class="next i-next" {$no_follow_text} href="{$link->goPage($requestPage, $p_next)}"> 
                        <img src="{$img_dir}pager_arrow_right.gif" alt="{l s='Next'}" class="v-middle" />
                    </a></li>
                {else}
                <li><a class="next i-next hidden" {$no_follow_text} href="#"> 
                        <img src="{$img_dir}pager_arrow_right.gif" alt="{l s='Next'}" class="v-middle" />
                    </a>
                </li>
                {/if}
