            ...
            var open_multishipping_fancybox = {$open_multishipping_fancybox|intval};
                            ...
                            <div class="addresses clearfix">
                                ...
                                <p id="address_invoice_form" class="select" {if $cart->id_address_invoice == $cart->id_address_delivery}style="display: none;"{/if}>
                                    ...
                                    {else}
                                        <a  href="{$link->getPageLink('address', true, NULL, "back={$back_order_page}?step=1&select_address=1{if $back}&mod={$back}{/if}")}" title="{l s='Add'}" class="button">{l s='Add a new address'}</a>
                                    {/if}
                                </p>
                                <div class="clearfix">
                                ...
                                <p class="address_add submit">
                                    <a href="{$link->getPageLink('address', true, NULL, "back={$back_order_page}?step=1{if $back}&mod={$back}{/if}")}" title="{l s='Add'}" class="button">{l s='Add a new address'}</a>
                                </p>
                                {if !$opc}
                            ...
                            {if !$opc}
                                <p class="cart_navigation submit">
                                    ...
                                    <a href="{$link->getPageLink($back_order_page, true, NULL, "step=0{if $back}&back={$back}{/if}")}" title="{l s='Previous'}" class="button left"> <span><span>&laquo;{l s='Previous'}</span></span></a>
