...
<div class="addresses" id="featured-products_block_center">
	...
	<div class="ajax_block_product">
		...
		{/if}
                <br />{l s='Quantity:' mod='blockwishlist'}<input type="text" id="{$product.id_product}_{$product.id_product_attribute}" style="width:30px;" size="3" value="{$product.quantity|intval}" readonly/>
