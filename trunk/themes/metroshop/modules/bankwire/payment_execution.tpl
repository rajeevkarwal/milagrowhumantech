                ...
                {else}
                    ...
                    <form action="{$link->getModuleLink('bankwire', 'validation', [], true)}" method="post">
                        ...
                        <p class="cart_navigation">
                            <button type="submit" name="submit" class="button"><span><span>{l s='I confirm my order' mod='bankwire'}</span></span></button>
                           
                            <button onclick="window.location='{$link->getPageLink('order', true, NULL, "step=3")}'"  title="{l s='Other payment methods' mod='bankwire'}" class="button right" type="button"><span><span>{l s='Other payment methods' mod='bankwire'}</span></span></button>
