   ...
   // Your Twitter App Consumer Key
	...
	private function getTwitterJSON() {
		...
		$tmhOAuth = new tmhOAuth(array(
			...
			'consumer_key'          => Configuration::get('metro_consumer_key'),
			'consumer_secret'       => Configuration::get('metro_consumer_secret'),
			'user_token'            => Configuration::get('metro_consumer_token'),
			'user_secret'           => Configuration::get('metro_consumer_tsecret'),
