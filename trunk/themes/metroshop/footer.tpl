...
<div class="facebookOuter">
 <div class="facebookInner">
             ...
             {if $dedalx.metro_facebook_page_url}
                <div class="fb-like-box" data-href="{$dedalx.metro_facebook_page_url}" data-width="235" data-height="205" data-show-faces="true" data-colorscheme="dark" data-stream="false" data-show-border="false"  data-border-color="#1F2B36" data-header="false"></div>       
            {else}
