                            ...
                            <form action="{$link->getPageLink('authentication', true)}" method="post" id="create-account_form">
                                ...
                                <ul class="form-list">
                                    <li>
                                        ...
                                        <div class="input-box">
                                            <input type="text" id="email_create" name="email_create" value="{if isset($smarty.post.email_create)}{$smarty.post.email_create|stripslashes}{/if}" class="input-text required-entry validate-email" />
                                        </div>
                                    </li>
                                </ul>
                                <div class="buttons-set">
                                {if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
                                <button type="submit" id="SubmitCreate" name="SubmitCreate" class="button" ><span><span>{l s='Create your account'}</span></span></button>
                        ...
                        <form action="{$link->getPageLink('authentication', true)}" method="post" id="login_form">
                            ...
                            <ul class="form-list">
                                <li>
                                    ...
                                    <div class="input-box">
                                        <input type="text" id="email" name="email" value="{if isset($smarty.post.email)}{$smarty.post.email|stripslashes}{/if}" class="account_input input-text required-entry " />
                                ...
                                <li>
                                    ...
                                    <div class="input-box">
                                        <input type="password" id="passwd" name="passwd" value="{if isset($smarty.post.passwd)}{$smarty.post.passwd|stripslashes}{/if}" class="account_input input-text required-entry" />
                                    </div>
                            ...
                            {if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
                            <button type="submit" id="SubmitLogin" name="SubmitLogin" class="button"><span><span>{l s='Log in'}</span></span></button>
            ...
            {if isset($inOrderProcess) && $inOrderProcess && $PS_GUEST_CHECKOUT_ENABLED}
                <form action="{$link->getPageLink('authentication', true, NULL, "back=$back")}" method="post" id="new_account_form" class="std clearfix">
                    ...
                    <p class="cart_navigation required submit">
                        ...
                        <button type="submit" class="button" name="submitGuestAccount" id="submitGuestAccount"><span><span>{l s='Continue'}</span></span></button>
                    </p>
                </form>
            {/if}
            {else}
                ...
                {/if}-->
                    <form action="{$link->getPageLink('authentication', true)}" method="post" id="account-creation_form" class="std">
                        ...
                        <fieldset
                            ...
                            {if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
                            <button type="submit" name="submitAccount" id="submitAccount" class="button btn_button float-right"><span><span>{l s='Register'}</span></spna></button>
                            <span><sup>*</sup>{l s='Required field'}</span>
                        </p>
                    </fieldset>
                </form>
