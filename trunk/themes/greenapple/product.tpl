                        ...
                        <div  class="main-image" id="image-block">
                            ...
                            <div id="views_block" class="more-views {if isset($images) && count($images) < 2}hidden{/if}">                                 
                                ...
                                <div id="thumbs_list" class="zoom-gallery slider">
                                    <ul id="thumbs_list_frame" class="zoom-gallery slider" style="width: 100%;">
    ...
    jQuery("a[rel^='prettyPhoto']").prettyPhoto();
            ...
            <div class="product-shop" id="pb-left-column">
                <div class="white-back">
                    ...
                    <div style="display: inline-block; float: right;"><a href="{$link->getPageLink('products-comparison')}" title="" class="compaate_button">{l s='Compare'}</a></div>
...
{if $attachments}<li><a id="more_info_tab_attachments" href="#idTab9">{l s='Product Downloads'}</a></li>{/if}
