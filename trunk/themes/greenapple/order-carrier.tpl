    ...
    <div class="main">
        <div class="col-main">
            <div class="account-login">
                ...
                {if !$opc}<h1>{l s='Shipping'}</h1>{else}
...
{if !$opc}
    ...
    <p class="cart_navigation submit">
        ...
        {if !$is_guest}
            ...
            {if $back}
                 <button onclick="window.location='{$link->getPageLink('order', true, NULL, "step=1&back={$back}&multi-shipping={$multi_shipping}")}'"  title="{l s='Previous'}" class="button left" type="button"><span><span>&laquo; {l s='Previous'}</span></span></button>
            {else}
<button onclick="window.location='{$link->getPageLink('order', true, NULL, "step=1&multi-shipping={$multi_shipping}")}'"  title="{l s='Previous'}" class="button left" type="button"><span><span>&laquo; {l s='Previous'}</span></span></button>


            {/if}

        {else}
            <button onclick="window.location='{$link->getPageLink('order', true, NULL, "multi-shipping={$multi_shipping}")}'"  title="{l s='Previous'}" class="button left" type="button"><span><span>&laquo; {l s='Previous'}</span></span></button>
        {/if}

        {if isset($virtual_cart) && $virtual_cart || (isset($delivery_option_list) && !empty($delivery_option_list))}

            <button type="submit" name="processCarrier"  class="button right" ><span><span>{l s='Next'} &raquo;</span></span></button>
