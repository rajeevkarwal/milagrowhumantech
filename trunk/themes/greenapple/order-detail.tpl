...
{if count($order_history)}
    ...
    <div class="table_block">      
        <table class="data-table cart-table" id="shopping-cart-table">
            ...
            <thead>
                <tr class="first last">
                    <th rowspan="1">{l s='Date'}</th>
                    <th rowspan="1"><span class="nobr">{l s='Status'}</span></th>
                </tr>
            </thead>  
            <tbody>
...
<form action="{$link->getPageLink('order-detail', true)}" method="post" class="std" id="sendOrderMessage">
    ...
    <p>
        ...
        <select name="id_product" style="width:30%;">
    ...
    <p class="submit">
        ...
        <button type="submit" class="button btn_button" name="submitMessage" ><span><span>{l s='Send'}</span></span></button>
    </p>
</form>
{else}
