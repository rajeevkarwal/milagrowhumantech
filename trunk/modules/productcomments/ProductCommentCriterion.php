...
class ProductCommentCriterion extends ObjectModel
{
    ...
    public static function updateGrade($id_product_comment, $id_product_comment_criterion, $grade)
    {
        if ($grade < 0)
            $grade = 0;
        else if ($grade > 10)
            $grade = 10;
        Db::getInstance()->update('product_comment_grade', array('grade' => $grade), "id_product_comment=$id_product_comment and id_product_comment_criterion=$id_product_comment_criterion");
