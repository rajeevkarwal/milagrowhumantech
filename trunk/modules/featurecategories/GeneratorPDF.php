...
class GeneratorPDF extends TCPDF
{
...
//        $this->writeHTML($this->footer);
        $this->writeHTML('<table style="width: 100%"><tr><td style="text-align:left;">Page ' . $this->getAliasNumPage() . '/' . $this->getAliasNbPages() . '</td></tr></table>');
    }
