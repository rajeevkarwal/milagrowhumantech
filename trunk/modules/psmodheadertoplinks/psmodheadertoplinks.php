...
if (!defined('_PS_VERSION_'))
	exit;
class PsmodHeaderToplinks extends Module
{
	public function __construct()
	{
		$this->name = 'psmodheadertoplinks';
		...
		parent::__construct();
		$this->displayName = $this->l('Any-Themes Header Top Links');
	...
	*/
	public function hookTop($params)
	{
		...
		return $this->display(__FILE__, 'psmodheadertoplinks.tpl');
	}
