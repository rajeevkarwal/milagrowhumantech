...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if(product != 'No product'){
            ...
            productName = $("#product option[value='"+ product +"']").text();
...
<form id="amc" action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" class="cms-banner"
 ...
 <p class="cms-banner-img"><img alt="milagrow-trackorder-banner" src="/img/cms/cms-banners/annual-maintenance-contract.png"></p> 

<p>
    As an esteemed Milagrow customer you can be rest assured that even after the expiry of warranty period of
    the product, you will continue to enjoy the same care and benefits through this extended warranty plan which
    will safeguard you against Uncertainty & Inconvenience.
</p>

<p><strong>Savings from unexpected high repair cost:</strong><br/>All the major operational parts (no matter how
    costly they are) & service charges are covered under this plan which comes to you at an amazingly nominal
    cost. </p>

<p>
    <strong>Special service</strong><br/>
    We have contracted with FedEx (World's No.1, Most Trusted Courier) to pickup the Robot(s) from your
    home/office in case of hardware failure or any other related problem.<br/>
    We mostly receive them within 48-72 hours at company owned Service Centres at various places. Mostly we
    rectify it within 24-48 hours and send it back after perfect servicing and fine tuning. Turnaround time for
    you will be maximum 6-7 days in most cases..<br/>
    We do not want our customers to suffer at the outsourced and ill equipped service centres. We understand the
    ...
    We are committed to providing you with the best service and we have a strong ambition to be India's most
    respected service organization.
</p>

<p>
    <strong>Assured and Unlimited Service </strong><br/>
    In order to serve you in a competent manner we have got a dedicated team of engineers trained at our own
...
<p>
    ...
    Electronic parts of main product shall be replaced/repaired, free of cost in case of any breakdown during
...
<p>Take advantage of our extended service offer and enjoy the coverage provided to you even after the expiry of
    the original warranty period of the product.</p>

<p><strong>Genuine Spares and regular maintenance will help you in extending the life of your Product.</strong>
</p>

<p>For further information regarding AMC prices etc. kindly contact us on customercare@milagrow.in</p>
<br/>
<ul class="form-list">
    <li>
    ...
    <li>
        <label for="cost" class="required"><em>*</em>Maintenance Cost</label>
    ...
    <li>
        <label for="duration" class="required"><em>*</em>Duration</label>
    ...
    {*<li>*}
    {*<label for="country" class="required"><em>*</em>Select Country</label>*}
    ...
    <li>
        ...
        <div class="input-box">
            <input type="text" id="date" name="date" value="{if isset($date)}{$date|escape:'htmlall':'UTF-8'|stripslashes}{/if}" readonly/>
        </div>
    </li>
    ...
    <li>
        ...
        <br/>If invoice is not available please attach the serial number photograph or photograph of the product.
    ...
    <li>
        ...
        <div class="input-box">
            <textarea name="special_comments" style="width:36%">{if isset($special_comments)}{$special_comments|escape:'htmlall':'UTF-8'|stripslashes}{/if}</textarea>
        </div>
    </li>
