...
if(isset($_POST['reg']))
{
 ...
 $sql="INSERT INTO `ps_test2` (`name`, `email`) VALUES ('".$name."', '".$email."')";
...
//echo  $sql="INSERT INTO `ps_test2` (`name`, `email`) VALUES ('name4', 'email4@email.com')";
...
echo "testing for register";
 ...
 <div id="RegisterPopupError">
  ...
  <p class="cart_navigation required submit">
      <input type="submit" name="reg" value="Register" onclick="return validatereg();" />
     </p>
    </fieldset>
    </form>    
