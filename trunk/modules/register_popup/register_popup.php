...
//                    $smarty->assign('gosf_coupon_code', '');
                    ...
                    } elseif ($host == 'milagrowhumantech.com/floor-robots/109-milagrow-redhawk-india-s-number-1-floor-robots.html' || $host == 'milagrowhumantech.com/floor-robots/442-milagrow-redhawk10-refurbished-.html') {
                        $send = Mail::Send($id_lang, 'gosf_fr_redhawk3', $sub, $vars, $email);
                    } 
                   
                    elseif ($host == 'milagrowhumantech.com/floor-robots/110-blackcat1.html' || $host == 'milagrowhumantech.com/floor-robots/217-blackcat2.html'  || $host == 'milagrowhumantech.com/67-floor-robot-accessories' || $host == 'milagrowhumantech.com/68-batteries' || $host == 'milagrowhumantech.com/70-brushes-sweepers' || $host == 'milagrowhumantech.com/75-chargers-cables' || $host == 'milagrowhumantech.com/73-docking-stations' || $host == 'milagrowhumantech.com/71-filters' || $host == 'milagrowhumantech.com/69-dustbin-mops-pads' || $host == 'milagrowhumantech.com/72-remotes' || $host == 'milagrowhumantech.com/74-virtual-walls'){
                    ...
                    elseif ( $host=='milagrowhumantech.com/lawn-robots/229-robonicklaus-20-8908002152708.html' || $host == 'milagrowhumantech.com/lawn-robots/229-robonicklaus-20.html'){
                        $send = Mail::Send($id_lang, 'gosf_rn20', $sub, $vars, $email);
                    }
