...
//                    $smarty->assign('gosf_coupon_code', '');
                    ...
                    if ($host == 'milagrowhumantech.com' || $host=='http://milagrowhumantech.com/content/38-contact-us' || $host == 'milagrowhumantech.com/' || $host=='http://milagrowhumantech.com/content/category/2-buying-guides' || $host=='http://milagrowhumantech.com/content/category/5-etailers') {
                        $send = Mail::Send($id_lang, 'gosf', $sub, $vars, $email);
                    } elseif ($host == 'milagrowhumantech.com/87-body-robots' ||$host=='http://milagrowhumantech.com/body-robots/23-robotic-body-massager-700112167935.html'|| $host=='milagrowhumantech.com/111-wheeme-red'||$host=='milagrowhumantech.com/112-wheeme-blue' || $host == 'milagrowhumantech.com/137-body-robot-models' || $host == 'milagrowhumantech.com/body-robots/23-robotic-body-massager.html' || $host=='http://milagrowhumantech.com/body-robots/90-robotic-body-massager-blue-700112167942.html' || $host=='http://milagrowhumantech.com/content/18-robotic-massagers' ) {
                        $send = Mail::Send($id_lang, 'gosf_br', $sub, $vars, $email);
                    } elseif ($host == 'milagrowhumantech.com/85-floor-robots' || $host=='http://milagrowhumantech.com/content/category/4-buying-guides-for-floor-robots' || $host=='http://milagrowhumantech.com/content/16-robotic-floor-cleaners' || $host=='http://milagrowhumantech.com/floor-robots/428-milagrow-blackcat20-refurbished.html' || $host=='http://milagrowhumantech.com/floor-robots/221-ecovacs-deebot-66-6943757601615.html' ||$host=='http://milagrowhumantech.com/floor-robots/507-milagrow-ecovacs-3d-deebot-79.html' || $host=='http://milagrowhumantech.com/floor-robots/220-ecovacs-deebot-63-6943757602032.html' || $host=='http://milagrowhumantech.com/floor-robots/508-phillips-easystar-fc8800.html' || $host == 'milagrowhumantech.com/85-floor-robots/' || $host == 'milagrowhumantech.com/85-floor-robots/#') {
                   ...
                   // } elseif ($host == 'milagrowhumantech.com/122-pool-robot-accessories'){
                    ...
                    } elseif ($host == 'milagrowhumantech.com/pool-robots/233-robophelps-true-blue.html' || $host == 'milagrowhumantech.com/138-charger-cable' || $host == 'milagrowhumantech.com/139-caddy' || $host == 'milagrowhumantech.com/140-dustbin' || $host == 'milagrowhumantech.com/152-remote') {
                    ...
                    } elseif ($host == 'milagrowhumantech.com/quad-core/75-104-pro-3g-sim-quad-core-16gb.html' || $host=='http://milagrowhumantech.com/content/15-tablet-pcs' || $host=='http://milagrowhumantech.com/content/category/3-buying-guides-for-tabtops') {
                        $send = Mail::Send($id_lang, 'gosf_m2pro32gb', $sub, $vars, $email);
                    ...
                    else if($host=='http://milagrowhumantech.com/floor-robots/506-milagrow-ecovacs-deebot-dm-85.html'||$host== 'milagrowhumantech.com/floor-robots/504-milagrow-aguabot-4-0-robotic-floor-cleaner-with-water-tank-8908002152081.html'||$host== 'milagrowhumantech.com/floor-robots/575-milagrow-aguabot-5-0-indias-1st-full-wetmopping-and-drycleaning-floor-robovac-8908002152081.html')
                    {
