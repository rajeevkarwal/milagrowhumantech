...
//                    $smarty->assign('gosf_coupon_code', '');
                    ...
                    if ($host == 'milagrow.net' || $host=='http://milagrowhumantech.com/content/38-contact-us' || $host == 'milagrow.net/' || $host=='http://milagrowhumantech.com/content/category/2-buying-guides' || $host=='http://milagrowhumantech.com/content/category/5-etailers') {
                        $send = Mail::Send($id_lang, 'gosf', $sub, $vars, $email);
                    } elseif ($host == 'milagrow.net/87-body-robots' ||$host=='http://milagrowhumantech.com/body-robots/23-robotic-body-massager-700112167935.html'|| $host=='milagrow.net/111-wheeme-red'||$host=='milagrow.net/112-wheeme-blue' || $host == 'milagrow.net/137-body-robot-models' || $host == 'milagrow.net/body-robots/23-robotic-body-massager.html' || $host=='http://milagrowhumantech.com/body-robots/90-robotic-body-massager-blue-700112167942.html' || $host=='http://milagrowhumantech.com/content/18-robotic-massagers' ) {
                        $send = Mail::Send($id_lang, 'gosf_br', $sub, $vars, $email);
                    } elseif ($host == 'milagrow.net/85-floor-robots' || $host=='http://milagrowhumantech.com/content/category/4-buying-guides-for-floor-robots' || $host=='http://milagrowhumantech.com/content/16-robotic-floor-cleaners' || $host=='http://milagrowhumantech.com/floor-robots/428-milagrow-blackcat20-refurbished.html' || $host=='http://milagrowhumantech.com/floor-robots/221-ecovacs-deebot-66-6943757601615.html' ||$host=='http://milagrowhumantech.com/floor-robots/507-milagrow-ecovacs-3d-deebot-79.html' || $host=='http://milagrowhumantech.com/floor-robots/220-ecovacs-deebot-63-6943757602032.html' || $host=='http://milagrowhumantech.com/floor-robots/508-phillips-easystar-fc8800.html' || $host == 'milagrow.net/85-floor-robots/' || $host == 'milagrow.net/85-floor-robots/#') {
                    ...
                    } elseif ($host == 'milagrow.net/105-lawn-robots' || $host=='http://milagrowhumantech.com/content/category/2-buying-guides' || $host == 'milagrow.net/115-lawn-robot-models'  || $host == 'milagrow.net/123-lawn-robot-accessories' || $host === 'milagrow.net/lawn-robot-accessories/302-virtual-wire.html' || $host == 'milagrow.net/lawn-robot-accessories/303-peges.html' || $host =='milagrow.net/lawn-robot-accessories/305-docking-station.html' || $host == 'milagrow.net/remote/344-robo-nicklaus-20.html' || $host =='milagrow.net/batteries/392-nicklaus-20-battery.html' || $host == 'milagrow.net/blades/412-lawn-robots-blades-for-nicklaus20.html' || $host == 'milagrow.net/charger/416-lawn-robots-charger-for-robo-nicklaus20-tiger-20.html' || $host == 'milagrow.net/batteries/413-robo-nicklaus-20-battery.html' || $host == 'milagrow.net/docking-station/415-robo-tiger-20-tiger-10-docking-station.html' || $host == 'milagrow.net/batteries/392-nicklaus-20-battery.html' || $host == 'milagrow.net/batteries/413-robo-nicklaus-20-battery.html' || $host == 'milagrow.net/141-batteries' || $host == 'milagrow.net/146-remote' || $host == 'milagrow.net/145-docking-station' || $host == 'milagrow.net/144-blades' || $host == 'milagrow.net/143-pegs' || $host == 'milagrow.net/142-virtual-wire' || $host == 'milagrow.net/151-charger') {
                        $send = Mail::Send($id_lang, 'gosf_ln', $sub, $vars, $email);
                    } 
                	else if($host == 'milagrow.net/lawn-robots/231-robotiger-20.html' || $host == 'milagrow.net/lawn-robots/232-robotiger-10.html' )
                	{
                		 $send = Mail::Send($id_lang, 'gosf_robotiger2', $sub, $vars, $email);
                	}
                    elseif ($host == 'milagrow.net/lawn-robots/229-robonicklaus-20.html'){
                        $send = Mail::Send($id_lang, 'gosf_ln_rb_nick', $sub, $vars, $email);
                    } elseif ($host == 'milagrow.net/113-pool-robots' || $host=='http://milagrowhumantech.com/content/category/12-buying-guide-for-pool-robots' || $host=='http://milagrowhumantech.com/content/62-pool-robots' || $host == 'milagrow.net/114-pool-robot-models' || $host == 'milagrow.net/122-pool-robot-accessories' || $host == 'milagrow.net/pool-robot-accessories/299-caddy.html' || $host == 'milagrow.net/pool-robot-accessories/300-dustbin.html' || $host == 'milagrow.net/pool-robot-accessories/298-charger-cable.html' || $host == 'milagrow.net/pool-robot-accessories/322-remote.html' || $host == 'milagrow.net/pool-robot-accessories/323-charger-.html' || $host == 'milagrow.net/pool-robot-accessories/298-charger-cable.html' || $host == 'milagrow.net/pool-robot-accessories/323-charger-.html' || $host == 'milagrow.net/pool-robot-accessories/299-caddy.html' || $host == 'milagrow.net/pool-robot-accessories/300-dustbin.html' || $host == 'milagrow.net/pool-robot-accessories/322-remote.html') {
                   ...
                   // } elseif ($host == 'milagrow.net/122-pool-robot-accessories'){
                    ...
                    } elseif ($host == 'milagrow.net/pool-robots/233-robophelps-true-blue.html' || $host == 'milagrow.net/138-charger-cable' || $host == 'milagrow.net/139-caddy' || $host == 'milagrow.net/140-dustbin' || $host == 'milagrow.net/152-remote') {
                        $send = Mail::Send($id_lang, 'gosf_pr_15', $sub, $vars, $email);
                    } elseif ($host == 'milagrow.net/pool-robots/419-milagrow-robophelps20.html') {
                    ...
                    } elseif ($host == 'milagrow.net/quad-core/75-104-pro-3g-sim-quad-core-16gb.html' || $host=='http://milagrowhumantech.com/content/15-tablet-pcs' || $host=='http://milagrowhumantech.com/content/category/3-buying-guides-for-tabtops') {
                        $send = Mail::Send($id_lang, 'gosf_m2pro32gb', $sub, $vars, $email);
                    ...
                    else if($host=='http://milagrowhumantech.com/floor-robots/506-milagrow-ecovacs-deebot-dm-85.html'||$host== 'milagrow.net/floor-robots/504-milagrow-aguabot-4-0-robotic-floor-cleaner-with-water-tank-8908002152081.html'||$host== 'milagrow.net/floor-robots/575-milagrow-aguabot-5-0-indias-1st-full-wetmopping-and-drycleaning-floor-robovac-8908002152081.html')
                    {
