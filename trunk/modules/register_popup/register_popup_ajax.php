...
if ($action == 'showRegisterPopup') {
    $html = $context->smarty->fetch(dirname(__FILE__) . '/register_pop_up_form.tpl');
    echo json_encode(array('html' => $html));
    exit;
} elseif ($action == 'submitRegister') {
    $hasError = false;
	
	$fname = trim(Tools::getValue('customer_firstname'));
    $lname = trim(Tools::getValue('customer_lastname'));
