...
class PsModNewsLetter extends Module
{
	...
	{
		$this->name = 'psmodnewsletter';
		$this->tab = 'front_office_features';
		$this->need_instance = 0;

		parent::__construct();

		$this->displayName = $this->l('Any-Themes Newsletter');
		$this->description = $this->l('Add a block for newsletter subscription.');
	...
	{
		$verif_url = Context::getContext()->link->getModuleLink('psmodnewsletter', 'verification', array(
			'token' => $token,
		));
	...
	public function hookDisplayFooter($params)
	{
		...
		return $this->display(__FILE__, 'psmodnewsletter.tpl');
	} 
