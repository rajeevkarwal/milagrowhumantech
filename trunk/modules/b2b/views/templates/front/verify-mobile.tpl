            ...
            <div class="account-login input-type-field">
                ...
                <div class="col2-set">
                    <div class="col-1 new-users box-in">
                        <div class="content">
                            <form action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" id="verifyForm"
                                  data-ajax="true">
                                <h2>Verify Mobile</h2>
                                ...
                                <ul class="form-list">
                                    <li>
                                        <label for="code" class="required"><em>*</em>Enter your verification
                                            Code</label>
                    ...
                    <div class="col-1 box-in registered-users">
                        <div class="content">
                            <form action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" id="updateForm"
                                  novalidate="" data-ajax=true>
                                <h2>Update Mobile</h2>
