...
<center>
    ...
    <form method="post" action="https://www.fedex.com/FWIW/Client/Tracking_v8/ClientTrackInit" id="clientForm"
          style="display: none">
        <table width="100%" border="0" cellpadding="10" style='text-align: left;' align="center">
            <tr>
            ...
            <tr>
                <td align="left">
                    <table class="Intro" width="565px" cellspacing="0" cellpadding="0"
                           style="font-family:Helvetica; text-align: left; color:Black; background-color:WhiteSmoke; font-size:11px;border:Red 1px solid;">
                        <tr>
                        ...
                        <tr>
                            <td align="right" colspan=3><input type="submit" value="Track"
                                ...
                                <input id="hdnQuery" name="hdnQuery" type="hidden"
                                       value=""/>
                            </td>
                        </tr>
                    </table>
                </td>
