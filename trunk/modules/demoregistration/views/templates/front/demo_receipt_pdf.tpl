...
<div style="font-size: 8pt; color: #444;">
            ...
            <td style="width: 100%;">
                <table style="width: 100%; font-size: 8pt;">
                    ...
                    <tr style="line-height:6px;background-color:#DDD;">
                        <td style="text-align: left; width: 50%">Pre Sales Home Demo for {$category}</td>
    ...
    <table style="width: 100%">
        <tr>
            <td style="text-align: right; font-weight: bold">&nbsp;Received with thanks {displayPrice currency=1 price=$demoPriceTotal}<br> Accounts Department,
                Milagrow
            </td>
        </tr>
    </table>
