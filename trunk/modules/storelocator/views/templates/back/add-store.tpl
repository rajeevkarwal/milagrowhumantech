<fieldset style="margin-top: 80px;">
    <form action="{$url|escape:'htmlall':'UTF-8'}" method="post">
        ...
        <legend><img src="{$module_dir}img/icon-config.gif" alt=""/>{l s='Add New Store' mod='storelocator'}</legend>
        ...
        <div class="margin-form">
            <input type="text" name="city" id="city" style="width:230px;" {if !empty($selectedCity)}value="{$selectedCity}" {/if}> <sup>*</sup>
        </div>
        <label for="location">Location</label>

        <div class="margin-form">
            <input type="text" name="location" id="location" style="width:230px;"> <sup>*</sup>
        </div>
        <label for="location">Store Name</label>

        <div class="margin-form">
            <input type="text" name="storeName" id="storeName" style="width:230px;"> <sup>*</sup>
        </div>
        <label for="phoneNumber">Phone Number</label>

        <div class="margin-form">
            <input type="text" name="phoneNumber" id="phoneNumber" style="width:230px;"> <sup>*</sup>
        </div>
        <label for="address">Address</label>

        <div class="margin-form">
            <textarea name="address" id="address" rows="10" cols="50"></textarea> <sup>*</sup>
        </div>
        <label>&nbsp;</label>

        <div class="margin-form">
            <input type="submit" name="saveStore" value="Save"/>
        </div>
