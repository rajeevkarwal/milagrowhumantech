...
(function($) {
	...
	$.widget("ui.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		serialize: function(o) {
			...
			$(items).each(function() {
				...
				if (res) { 
					...
					str.push(list_+'['+id+'][pos]'+'='+pos_   + '&' +   list_+'['+id+'][title]'+'='+theTitle  + '&' +   list_+'['+id+'][class]'+'='+theClass  + '&' +   list_+'['+id+'][type]'+'='+theType  + '&' +   list_+'['+id+'][content]'+'='+theContent);
				}
		...
		toArray: function(o) {
			...
			ret.push({"item_id": 'root', "item_title": '', "item_class": '', "item_type": '', "item_content": '', "parent_id": 'none', "depth": sDepth, "left": '1', "right": ($('li', this.element).length + 1) * 2});
			...
			function _recursiveArray(item, depth, left) {
				...
				*/
				...
				if (id != null) {
						ret.push({"item_id": id[2], "item_title": theTitle, "item_class": theClass, "item_type": theType, "item_content": theContent, "parent_id": pid, "depth": depth, "left": left, "right": right});
				}
