...
class TDnewsLetter extends Module
{
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('ThemesDeveloper Newsletter');
	...
	{
		$verif_url = Context::getContext()->link->getModuleLink('tdnewsletter', 'verification', array(
			'token' => $token,
		));
	...
	public function hookDisplayFooter($params)
	{
		...
		return $this->display(__FILE__, 'tdnewsletter.tpl');
	} 
