            ...
            <table class="table">
                ...
                {foreach from=$queriesList key=stores item=i}
                    <tr class="">
                        ...
                        {if empty($i['college_id_proof_file'])}
                           <td></td>

                        {else}

                          <td><a target="_blank" style="text-decoration:underline; color:#0000FF;" href="/upload/studentdiscount/{$i['college_id_proof_file']}">
                           view
                          </a></td>
                        {/if}
                        ...
                        <td>
                            <a onclick="return confirm('Are you sure?') ? true : false;"
                               ...
                               href="{$url}&sd_tab=delete_query&id_query={$i['id_student_discount']}">Delete</a>
                        </td>
