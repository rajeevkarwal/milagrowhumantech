...
{capture name=path}{l s='Shipping' mod='cod'}{/capture}
...
<form action="{$link->getModuleLink('cod', 'validation', [], true)}" method="post">
	...
	<p>
		<img src="{$this_path}cod.jpg" alt="{l s='Cash on delivery (COD) payment' mod='cod'}" style="float:left; margin: 0px 10px 5px 0px;" />
	...
	<p class="cart_navigation">
		...
		<input type="submit" name="submit" value="{l s='I confirm my order' mod='cod'}" class="exclusive_large" />
	</p>
</form>
