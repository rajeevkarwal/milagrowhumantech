...
<p>{l s='Your order on %s is complete.' sprintf=$shop_name mod='bankwire'}
		...
		<br /><br />{l s='If you have questions, comments or concerns, please contact our' mod='bankwire'} <a href="/customer-care">{l s='expert customer support team. ' mod='bankwire'}</a>.
	</p>
{else}
	<p class="warning">
		{l s='We noticed a problem with your order. If you think this is an error, feel free to contact our' mod='bankwire'} 
		<a href="/customer-care">{l s='expert customer support team. ' mod='bankwire'}</a>.
	</p>
{/if}
