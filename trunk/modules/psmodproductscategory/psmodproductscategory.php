...
class PsModProductsCategory extends Module
{
 	private $_html;

	public function __construct()
 	{
 	 	$this->name = 'psmodproductscategory';
 	 	$this->version = '1.1.0';
		$this->author = 'Any-Themes';
 	 	$this->tab = 'front_office_features';
		$this->need_instance = 0;
		parent::__construct();
		$this->displayName = $this->l('Any-Themes Products Category');
	...
	public function hookProductFooter($params)
	{
		...
		return $this->display(__FILE__, 'psmodproductscategory.tpl');
	}
