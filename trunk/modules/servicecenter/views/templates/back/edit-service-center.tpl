<fieldset style="margin-top: 80px;">
    <form action="{$url|escape:'htmlall':'UTF-8'}" method="post">
        ...
        <legend><img src="{$module_dir}img/icon-config.gif" alt=""/>{l s='Edit Service Center' mod='servicecenter'}
        </legend>
        ...
        <div class="margin-form">
            <input type="hidden" name="id_service_center" value="{$id_service_center}"/>
            <input type="submit" name="editServiceCenter" value="Update"/>
        </div>
