...
class MailAlert extends ObjectModel
{
    ...
    public static function customerHasNotificationWhenNotLogined($id_product,$id_product_attribute,$customer_email,$id_shop=null)
    {
        if ($id_shop == null)
        ...
        $sql = '
			...
			WHERE `customer_email` = \''.pSQL($customer_email).'\'
	...
	{
		$sql = '
			SELECT ma.`id_product`,ma.`created_at`,p.`quantity` AS product_quantity, pl.`name`, ma.`id_product_attribute`
