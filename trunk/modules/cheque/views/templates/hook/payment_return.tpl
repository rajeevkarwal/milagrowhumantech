...
{if $status == 'ok'}
	<p>{l s='Your order on %s is complete.' sprintf=$shop_name mod='cheque'}
		<br /><br />
		{l s='Your cheque must include:' mod='cheque'}
		...
		<br /><br />{l s='For any questions or for further information, please contact our' mod='cheque'} <a href="/customer-care">{l s='customer service department.' mod='cheque'}</a>.
	</p>
{else}
	<p class="warning">
		{l s='We have noticed that there is a problem with your order. If you think this is an error, you can contact our' mod='cheque'} 
		<a href="/customer-care">{l s='customer service department.' mod='cheque'}</a>.
	</p>
{/if}
