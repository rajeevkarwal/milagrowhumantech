...
<div class="span7">
    <p class="welcome-msg">{if $logged}
        ...
        {else}
            ...
            {/if} </p>
            <ul class="links">
                <li class="first" ><a href="{$link->getPageLink('my-account', true)}" title="{l s='my-account' mod='tdheadertoplinks'}">{l s='My Account' mod='tdheadertoplinks'}</a></li>
                <li ><a href="{$base_dir_ssl}modules/blockwishlist/mywishlist.php" title="My Wishlist" >{l s='My Wishlist' mod='tdheadertoplinks'}</a></li>
