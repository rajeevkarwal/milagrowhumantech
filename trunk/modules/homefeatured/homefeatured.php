...
class HomeFeatured extends Module
{
	...
	public function hookHeader($params)
	{
		...
		$this->context->controller->addCSS('/js/jquery/plugins/fancybox/jquery.fancybox.css', 'all');
	...
	public function hookDisplayHome($params)
	{
        ...
        // Readding price to resolve 0 price issue
        foreach($products as &$product){
            $product['price'] = Tools::displayPrice(Product::getPriceStatic((int)$product['id_product'], true),
                new Currency((int)Context::getContext()->cookie->id_currency));
        }
