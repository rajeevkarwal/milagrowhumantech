...
class OrderInvoiceCore extends ObjectModel
{
    ...
    //todo: changes done by keshav for product name not coming in invoice
    public function getProductsDetail()
    {
		...
		LEFT JOIN  `' . _DB_PREFIX_ . 'product_lang` pl ON (p.id_product = pl.id_product AND o.id_lang=pl.id_lang )
