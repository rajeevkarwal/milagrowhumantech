...
class AuthControllerCore extends FrontController
{
    ...
    {
		$user_mail = $customer->email;
		$email_admin = "ebiz@milagrow.in";
		$welcome = "Welcome! ";
		$mail_title=$welcome.' '.' '.' '.' '.$user_mail;
		$sub_admin="New Registration by".'     '.$user_mail;
		...
		Mail::Send($this->context->language->id, 'gosf_admin',$sub_admin, $vars, $email_admin));
    }
}
